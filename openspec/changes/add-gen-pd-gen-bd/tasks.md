...
- [ ] 2.1 `.agents/skills/gen-pd/SKILL.md`へ入力、出力、必須章、`TBD`、ID保持の規則を実装し、Skill定義を読み込めることを確認する
- [ ] 2.2 要求Artifactのサンプルから`要件定義書.md`と`要件定義書.docx`を生成し、要求IDとトレーサビリティが保持されることを確認する
